            ...
            ->addColumn('action', function($data){
                return '
                            <div style="text-align: left;">
                                <button class="btn btn-sm btn-outline-primary" data-transaksi="'.$data->id.'" data-update="3" data-notransaksi="'.$data->nomor_transaksi.'" onClick="lihatDokumen(event.target)">View Dokumen</button>
                            </div>
                        ';
            })
