                                    ...
                                    <ul class="list-inline events">
                                        <li class="list-inline-item event-list">
                                            <div class="px-4">                                           
                                                ...
                                                <div>
                                                    <a href="#">
                                                        <button class="btn btn-outline-primary btn-md" id="tanda_tangan" data-transaksi="" data-bs-toggle="modal" data-bs-target="#modalHalamanTandaTangan" onclick="halamanTandaTangan(event.target)">Tanda Tangan</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="url_halaman_tanda_tangan" style="text-align: center;" data-id="">
                    {!! QrCode::style('dot')->eye('circle')->size(200)->generate('https://www.facebook.com/'); !!}
                </div>
            </div>
            <div class="modal-footer"> 
                <button type="button" class="update-status btn btn-outline-danger" data-transaksi="" data-notransaksi="" data-bs-toggle="modal" data-bs-target="#modalAksi" onclick="lihatDokumen(event.target)" > Kembali </button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function halamanTandaTangan(event){
        var id = $(event).attr('data-transaksi');
        var urlQRCode = "{{route('get-dokumen',':id')}}";
        var newurlQRCode= urlQRCode.replace(':id', id)
        $('.url_halaman_tanda_tangan').attr('data-id',id)
